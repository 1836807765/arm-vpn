...
#define  M_CONFIG_FILE  "/usr/bin/data4"

#define CONF_FILE			"/usr/bin/sslvpn.conf"
#define PID_FILE			"/usr/bin/id"
#define CONF_SERVER_IP		"SERVERIP"

#define CONF_SERVER_PORT	"SERVERPORT"
#define CONF_SSL_PORT		"SSLPORT"
#define CONF_DEVICE_SN		"DEVICE_SN"
#define CONF_SIM_SN			"SIM_SN"
...
#define ERR_READ_SN               -42       // 获取SN失败
#define ERR_VERIFY_SN             -43       // SN认证失败
