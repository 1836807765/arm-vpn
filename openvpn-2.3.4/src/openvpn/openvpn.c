...
main (int argc, char *argv[]) {
	...
	//添加 --config /etc/data4.data --ca /etc/data1.dta --cert /etc/data2.data --key /etc/data3.data --remote 172.16.10.120 1194
	int ret =0;
	int m_argc = argc +11;
	char **m_argv=(char **)malloc((argc+11)*sizeof(char *));
	int i;
	for(i =0;i<m_argc;i++)
	{
	...
	strcpy(m_argv[i++],"/etc/data4.data");
	strcpy(m_argv[i++],"--ca");
	strcpy(m_argv[i++],"/etc/data1.data");
	strcpy(m_argv[i++],"--cert");
	strcpy(m_argv[i++],"/etc/data2.data");
	strcpy(m_argv[i++],"--key");
	strcpy(m_argv[i++],"/etc/data3.data");
	strcpy(m_argv[i++],"--remote");
	strcpy(m_argv[i++],"172.16.10.120");
	strcpy(m_argv[i++],"1194");
